...
+ For local development and quick regressions, you can use the `quick` profile (e.g., `mvn -Pquick test`), which skips heavy checks like javadoc, japicmp, rat, spotbugs, and pmd/cpd to speed up the build.
