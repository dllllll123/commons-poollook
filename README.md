...
+ For local containers or quick regression runs, use `mvn -Pquick test` to compile and run unit tests without the heavier javadoc, japicmp, RAT, SpotBugs, and PMD/CPD checks.
