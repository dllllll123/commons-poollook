...
+ To quickly compile and run tests only, use `mvn -Pquick test` which skips javadoc, japicmp, rat, spotbugs, pmd/cpd, and other heavy checks (suitable for local development and quick regressions).
