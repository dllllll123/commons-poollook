...
public class ResilientPooledObjectFactory<T, E extends Exception> implements PooledObjectFactory<T, E> {
    ...
    /**
     * Gets the count of exceptions of the specified type recorded by makeObject calls.
     *
     * @param exceptionClass the class of exception to get the count for
     * @return the count of exceptions of the specified type
     */
    public int getExceptionCount(final Class<?> exceptionClass) {
